...
(function(h) {
 ...
 function Ca(a) {
  ...
  if (a) {
   ...
   !a.sEmptyTable && (d && "No hay información disponible en la Tabla." === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
   !a.sLoadingRecords && (d && "Cargando..." === b.sLoadingRecords) && F(a,
 ...
 function qb(a) {
  var b = a.oClasses,
   ...
   e = a.oPreviousSearch,
   f = a.aanFeatures,
   g = '<input type="search" style="color: black;" class="' + b.sFilterInput + '"/>',
   j = d.sSearch,
 ...
 function Ab(a) {
  ...
  return c
    ...
    n.defaults = {
        ...
        iStateDuration: 7200,
        iDeferLoading: null,
        iDisplayLength: 10, //registros a mostrar.
        iDisplayStart: 0,
        iTabIndex: 0,
        oClasses: {},
        oLanguage: {
    ...
    sPrevious: "Anterior"
            ...
            sInfo: "Pagina _START_ a _END_ de _TOTAL_ totales",
            sInfoEmpty: "Pagina 0 a 0 de 0 totales",
            sInfoFiltered: "",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
